...
bool kia_alt_brake_msg = false;

//2018.09.06 12:27PM comment out safety beside brake and switch push
static void kia_rx_hook(CAN_FIFOMailBox_TypeDef *to_push) {

  // sample speed     //2018.09.06 11:49AM change 158 to 0x440
//  if ((to_push->RIR>>21) == 0x440) {
    // first 2 bytes
 ...
 // }
  ...
  //if ((to_push->RIR>>21) == 0x201 && (to_push->RDTR & 0xf) == 6) {
    ...
    ///f ((gas_interceptor > gas_interceptor_threshold) &&
